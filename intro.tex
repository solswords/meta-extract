...
correct, can be called by the ACL2 prover\footnote{
  ...
  cost of a {\em trust tag} marking this use as a source of
...
they have no effect on how those rules are applied during subsequent
proofs.  For that, we refer readers to existing papers
(\cite{meta-05,trusted-cl-proc}) as well as documentation~\cite{acl2:doc}
topics including META, CLAUSE-PROCESSOR, and EXTENDED-METAFUNCTIONS.
